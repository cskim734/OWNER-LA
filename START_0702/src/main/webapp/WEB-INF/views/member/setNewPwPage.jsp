...
<div class="main-menu">
	<form method="post">
		...
		<c:if test="${not empty m_Id}">
			...
			<div>
				<p>
					<label for="m_Pw">비밀번호 설정</label><input type="password" name="m_Pw"
						id="m_Pw" />
				</p>
				<span id="pwCheckResult"></span>
				<p>
					<label for="m_Pw2">비밀번호 확인</label><input type="password"
						name="m_Pw2" id="m_Pw2" /><br> <br> <input
						type="hidden" name="m_Id" value="${m_Id}">
				</p>
				<span id="pwConfirmResult"></span><br /> <input type="button"
					value="비밀번호 바꾸기" onclick="fn_setNewPw(this.form)" />
			</div>
		</c:if>
