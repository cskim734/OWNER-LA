	...
	<div class="main-wrap">
		...
		<section class="login_wrap">
			...
			<input type="checkbox" name="saveIDChk" />아이디 기억하기<br/><br/>
				...
				<br />
				<!-- 캡챠 -->
				아래 이미지를 보이는 대로 입력해주세요.<br /> <img
					src="${pageContext.request.contextPath }/${DIRECTORY }/${filename }"
					style="width: 300px;" /> <input id="img_load" type="button"
					value="이미지 새로고침" onclick="location.href='getImage'" /><br /> <input
					type="text" name="input_key" required /><br /> <br /> <input
					type="button" value="로그인" onclick="login(this.form)" /><br> <input
					type="checkbox" name="saveIDChk" />아이디 기억하기<br /> <br /> <a
					href="findIdPage">아이디찾기</a> / <a href="findPwPage">비밀번호찾기</a>
				<!--     
