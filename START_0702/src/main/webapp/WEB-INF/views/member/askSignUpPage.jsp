...
<div class="main-menu">
	<div class="signIn-head">
		<div class="login-title">
			<a href="#" onclick="history.go(-1);">로그인</a>
		</div>
...
본 약관은 2020년 1월 1일부터 시행합니다.
			...
			<input type="checkbox" name="req" value="true" id="req" /><label
				for="req">동의</label>
			<div>
				<p class="centered">개인정보 수집, 처리약관</p>
				<br />
				<textarea rows="10" cols="300"
					style="overflow-x: hidden; overflow-y: auto">
   			[개인정보 수집, 처리약관]
...
개인정보보호정책 게시일자: 2020-1-1
				...
				<input type="checkbox" name="req2" value="true" id="req2" /><label
					for="req2">동의</label>
			</div>
		</div>

		<input type="checkbox" id="allCheck" name="req3" value="true" /><label
			for="allCheck">약관 전체 동의하기
	</form>
	<h5 style="color: gray;">필수 약관을 동의 하셔야 회원가입이 가능합니다.</h5>
