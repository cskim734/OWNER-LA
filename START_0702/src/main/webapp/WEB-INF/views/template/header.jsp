...
<link
	href="https://fonts.googleapis.com/css2?family=Montserrat&family=Noto+Sans+KR&family=Open+Sans&display=swap"
	rel="stylesheet">
...
<link rel="stylesheet" type="text/css"
	href="resources/css/jquery.slidein.css">

<script src="https://unpkg.com/sweetalert/dist/sweetalert.min.js"></script>
<script type="text/javascript"
	src="//code.jquery.com/jquery-2.2.4.min.js"></script>
<script type="text/javascript"
	src="//code.jquery.com/ui/1.12.1/jquery-ui.min.js"></script>
...
.header {
	...
	background-image: linear-gradient(to bottom, rgb(223, 232, 201),
		rgb(195, 214, 155))
}
	...
	<div class="header">
				...
				<c:choose>
					...
					<c:when test="${mDTO.m_State eq 1}">
						...
						<div class="mypanel" id="mypanel">
							<ul>
								<li><a href="cartList?m_Id=${mDTO.m_Id }" class="datalayer"
									data-event="cart"><img
										src="<%=request.getContextPath()%>/resources/img/cart1.png"
										alt> 장바구니</a></li>
								<li><a href="productBuyList?m_No=${mDTO.m_No }"
									class="datalayer" data-event="buy"><img
										src="<%=request.getContextPath()%>/resources/img/buy.png" alt>
										구매현황</a></li>
								<li><a href="productSellList?m_No=${mDTO.m_No }"
									class="datalayer" data-event="sell"><img
										src="<%=request.getContextPath()%>/resources/img/sell.png"
										alt> 판매현황</a></li>
								<li><a href="qnaViewPage?m_No=${mDTO.m_No }"
									class="datalayer" data-event="qna"><img
										src="<%=request.getContextPath()%>/resources/img/qna.png" alt>
										1:1문의</a></li>
								<li><a href="productInsertPage" class="datalayer"
									data-event="qna"><img
										src="<%=request.getContextPath()%>/resources/img/enroll.png"
										alt>상품등록</a></li>
								<li><a href="moneyChargePage?m_No=${mDTO.m_No }"><img
										src="<%=request.getContextPath()%>/resources/img/money.png"
										alt>충전하기</a></li>
								<li><a href="myView"><img
								...
								<li><a href="logout"><img
										...
										alt> 로그아웃</a></li>
								<li style="color: #5F7D95;">잔액 : <fmt:formatNumber
										value="${mDTO.m_Money }" />원
								</li>
					...
					<c:when test="${mDTO.m_State eq 2}">
						...
						<div class="mypanel" id="mypanel">
							<ul>
								...
								<li><a href="memberView" class="datalayer" data-event="qna"><img
										src="<%=request.getContextPath()%>/resources/img/list.png"
										alt>회원관리</a></li>
								<li><a href="productManagementPage" class="datalayer"
									data-event="qna"><img
										src="<%=request.getContextPath()%>/resources/img/gift.png"
										alt>상품관리</a></li>
								<li><a href="qna_qAdminViewPage" class="datalayer"
									data-event="qna"><img
										src="<%=request.getContextPath()%>/resources/img/qna.png" alt>
										1:1문의</a></li>
		...
		<div class="logo">
			<h1 style="text-align: center;">
				<a href="home"> <img alt="owner_la_logo"
					src="resources/img/logoo.png" width="300px">
				</a>
			</h1>
		</div>
	...
	<div class="topnav">
		...
		<div class="dropdown">
			...
			<div class="dropdown-content">
				<div class="column">
					<a href="productListPage">전체</a> <a
						href="productCartegory?p_Cartegory=fashion">패션</a> <a
						href="productCartegory?p_Cartegory=digital">디지털</a> <a
						href="productCartegory?p_Cartegory=food">식품</a> <a
						href="productCartegory?p_Cartegory=book">도서</a> <a
						href="productCartegory?p_Cartegory=sports">스포츠</a> <a
						href="productCartegory?p_Cartegory=music">음반</a>
				</div>
			</div>
		</div>
		<c:if test="${mDTO.m_State eq 1 }">
			<a id="nav_title" style="padding-left: 400px;"
				href="productInsertPage">판매하기</a>
		</c:if>
	</div>