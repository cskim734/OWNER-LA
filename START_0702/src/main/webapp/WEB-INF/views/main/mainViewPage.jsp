...
<img alt="" src="${pDTO.p_Img_Path }">
<br />
<br />

구매
<form action="buyPage" method="post">
	구매가격 : <input type="text" name="b_Price" /> 즉시구매가격보여주기 <br />
	<br /> 입찰마감일 : <select name="b_Expiredate">
	...
	<br /> <input type="hidden" name="p_No" value="${pDTO.p_No }" /> <input
		type="hidden" name="m_No" value="${loginDTO.m_No }" /> <input
		type="submit" value="입찰하기" /> <input type="reset" value="다시입력" />
</form>
