	...
	<form enctype="multipart/form-data" method="post">
		<div class="inner_view">
			...
			<div class="left-wrap">
				...
				<p class="goods_name">
					상품명 <input type="text" name="p_Name" value="${pDTO.p_Name }"
						width="350px;" />


					<%-- <Strong class ="name" style="font-size: 20px;"> ${pDTO.p_Name } </Strong> --%>
				<p class="short_desc"
					style="font-size: 14px; padding: 4px 60px 10px 0; padding: 10px 0px;">
					<br> 상품 설명
					<textarea rows="10" cols="50" name="p_Content">${pDTO.p_Content }</textarea>
				</p>
				</p>
				<p class="goods_price">
					가격 <input type="text" name="p_Price" value="${pDTO.p_Price }" /><span
						class="won"> 원</span>
				</p>
				<div class="group_btn">
					<input type="hidden" name="p_No" value="${pDTO.p_No }" /> <input
						type="button" value="수정" onclick="fn_update(this.form)" />
