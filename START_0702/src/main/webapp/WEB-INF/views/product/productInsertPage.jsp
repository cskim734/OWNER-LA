	...
	<form method="post" enctype="multipart/form-data">
		...
		<table style="border: 1px solid #5F7D95">
			<tbody>
				...
				<tr>
					<td>가격</td>
					<td><input type="text" name="p_Price" placeholder="숫자만 적어주세요"
						style="width: 350px" /></td>
				</tr>
				<tr>
					<td>내용</td>
					<td><textarea rows="10" cols="50" name="p_Content"
							placeholder="내용에 상품의 상태를 적어주세요 예) 상급, 약간 사용감 있음, 새제품 등 "></textarea></td>
				</tr>
				<tr>
					<td>이미지</td>
		...
		<br> <input type="hidden" name="s_No" value="${mDTO.m_No }" /> <input
			type="button" value="등록하기" onclick="fn_ProductInsert(this.form)" />
		</td>
