	...
	<form name="f">
		<div class="inner_view">
			<div class="right-wrap">
				<div class="img">
					<img alt="${pDTO.p_Img_Path }" width="450px" height="400px"
						src="${pageContext.request.contextPath }/resources/storage/${pDTO.p_Img_Path }">
				</div>
			</div>
			<div class="left-wrap">
				<p class="goods_name">

					<span class="btn_cart "> <Strong class="name"
						style="font-size: 20px;"> ${pDTO.p_Name } </Strong> <c:if
							test="${pDTO.s_No ne mDTO.m_No and mDTO.m_No ne 1 and not empty mDTO}">
							<span id="img_location"> <img alt="cart"
								src="resources/img/cart.png" onclick="fn_cart()">
							</span>
						</c:if>
					</span> <br> <span class="short_desc"
						style="font-size: 14px; padding: 4px 60px 0 0;">
						${pDTO.p_Content } </span>
				</p>
				<p class="goods_price">
				...
				<div class="group_btn">
					...
					<input type="hidden" name="p_No" value="${pDTO.p_No }" /> <input
						type="hidden" name="m_No" value="${mDTO.m_No }" /> <input
						type="hidden" name="m_Id" value="${mDTO.m_Id }" /> <input
						type="hidden" name="p_Price" value="${pDTO.p_Price }" />
					<c:if
						test="${pDTO.s_No ne mDTO.m_No and mDTO.m_No ne 1 and not empty mDTO}">
						<input id="buy" type="button" value="구매"
							onclick="fn_Buy(this.form)" />
					...
					<input id="back" type="button" value="돌아가기"
						onclick="location.href='productListPage'" />
				</div>
			</div>
		</div>
