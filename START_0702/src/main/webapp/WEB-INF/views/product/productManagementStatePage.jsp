...
<div class="main-wrap">
	...
	<div class="filter">
		...
		<a href="productManagementPage">전체</a> <a
			href="productManagementState?p_State=1">판매중</a> <a
			href="productManagementState?p_State=2">승인대기중</a> <a
			href="productManagementState?p_State=-1">판매완료</a>
	</div>

	<div class="product-wrap">
		<div>
			<form action="productManagementStateSelect"
				...
				</select> <input type="text" name="query" style="height: 20px;"> <input
					type="hidden" name="p_State" value="${p_State }"> <input
					type="submit" value="검색">
			</form>
		</div>

		<p style="text-align: right; margin: auto; padding-right: 15%;">상품
			수 : ${totalRecord }</p>
		<ul class="product-list">
			...
			<c:if test="${not empty pDTO }">
				...
				<c:forEach var="pDTO" items="${pDTO }">
					...
					<li class="left-box"><a
						href="productViewPage?p_No=${pDTO.p_No }"> <img
							alt="${pDTO.p_Img_Path }" width="300px" height="300px"
							src="${pageContext.request.contextPath }/resources/storage/${pDTO.p_Img_Path }"></a>
