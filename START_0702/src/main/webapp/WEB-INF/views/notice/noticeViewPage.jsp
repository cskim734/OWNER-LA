			...
			<c:when test="${mDTO.m_State eq 2}">
				<div class="admin">
					<form method="post">
						...
						<br> <input type="hidden" name="n_No" value="${nDTO.n_No }" />
						<input type="button" value="수정하기"
							onclick="fn_noticeUpdate(this.form)" /> <input type="button"
							value="삭제하기" onclick="fn_noticeDelete(this.form)" /> <input
							type="button" value="목록으로" onclick="location.href='NoticePage'" />
					</form>
				</div>
